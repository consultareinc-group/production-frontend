  ...
  <MainContentWrapper>
    <PageBreadcrumbs
      ...
      :items="[
        ...
        {
          label: 'Edit Label Trace',
          to: { name: 'edit-label-trace' },
        },
      ]"
    />
    ...
    <SectionWrapper v-else class="q-mt-xl">
      ...
      <template #default>
        ...
        <div
          v-for="(label, index) in labelTraceLabels"
          :key="label.key"
        ...
        >
          <q-btn
            ...
            @click="openLabelDeleteDialog(label.key)"
          />
          <!-- Label Trace Labels -->
            ...
            <div class="relative-position">
              ...
              >
                ...
                <div class="q-gutter-y-md full-width">
                  <!-- Label Name -->
                  <div>
                    <label>Label Name <span class="text-red">*</span></label>
                    <q-input
                      outlined
                  ...
                  <div>
                    ...
                    <q-input
                      outlined
                      v-model="label.quantity_rejected"
                      dense
                      class="q-mt-sm"
                      :rules="[(val) => !!val || 'Field is required']"
                    />
                  ...
                  <div style="height: 90px">
                    ...
                    <q-input
                      disable
                      outlined
                      v-model="label.remaining_quantity"
                      dense
                ...
                <div class="q-gutter-y-md full-width">
                  ...
                  <div>
                    ...
                    <q-input
                      outlined
                      v-model="label.start_time_of_packing"
                      dense
                      class="q-mt-sm"
                      :rules="[(val) => !!val || 'Field is required']"
                    >
                  ...
                  <div>
                    ...
                    <q-input
                      outlined
                      v-model="label.end_time_of_packing"
                      dense
                      class="q-mt-sm"
                      :rules="[(val) => !!val || 'Field is required']"
                    >
    ...
    <!-- Delete Dialog -->
    <q-dialog v-model="labelDeleteDialog" persistent>
      <q-card class="q-px-xl relative-position">
        ...
        <q-card-section class="q-pt-none text-center">
          Are you sure you want to delete this label from the label trace
          record?
        </q-card-section>

        <q-card-section
          v-if="
            selectedLabel.label_name !== null &&
            selectedLabel.label_name !== undefined &&
        ...
        <q-card-section class="flex justify-center q-my-lg">
          ...
          <q-btn
            ...
            @click="deleteLabel(selectedLabel.key)"
            :disable="deleteLabelLoading"
          >
            <q-spinner v-if="deleteLabelLoading" />
    ...
    <div>
      <q-btn
        :disable="updateLabelTraceLoading"
        @click="updateLabelTrace"
        no-caps
        flat
...
const labelDeleteDialog = ref(false);
const deleteLabelLoading = ref(false);
const selectedLabel = ref(null);

const updateLabelTraceLoading = ref(false);
...
// Functions
const addSampleLabelTrace = () => {
  labelTraceLabels.value.push({
    key: Date.now(),
    label_name: "",
...
const openLabelDeleteDialog = (key) => {
  labelDeleteDialog.value = true;
  selectedLabel.value = labelTraceLabels.value.find((v) => v.key === key);
  console.log("Selected Label", selectedLabel.value);
};

const closeLabelDeleteDialog = () => {
  labelDeleteDialog.value = false;
...
const deleteLabel = (key) => {
  ...
  setTimeout(() => {
    labelTraceLabels.value = labelTraceLabels.value.filter(
      (v) => v.key !== key
    );
    deleteLabelLoading.value = false;
    closeLabelDeleteDialog();
  }, 1000);
};
...
const updateLabelTrace = () => {
  updateLabelTraceLoading.value = true;

  let payload = {
    production_batch_number: productionBatchNumber.value,
    sop_reference: sopReference.value,
    labels: labelTraceLabels.value,
  };
  ...
  setTimeout(() => {
    ...
    updateLabelTraceLoading.value = false;
  }, 1000);
};
</script>
