<template>
  <MainContentWrapper>
    ...
    <div>
      <q-btn
        :disable="saveLabelTraceLoading"
        @click="saveLabelTrace"
        no-caps
        flat
...
const saveLabelTraceLoading = ref(false);
...
const saveLabelTrace = () => {
  saveLabelTraceLoading.value = true;
  ...
  setTimeout(() => {
    ...
    saveLabelTraceLoading.value = false;
  }, 1000);
};
</script>
