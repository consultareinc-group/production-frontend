  ...
  <MainContentWrapper>
    <PageBreadcrumbs
      ...
      :items="[
        ...
        {
          label: 'Edit Post Production Verification',
          to: { name: 'edit-post-production-verification' },
        },
      ]"
    />
    ...
    <div>
      <q-btn
        @click="updatePostProductionVerification"
        label="Update"
        no-caps
        flat
...
const updatePostProductionVerification = () => {
  const payload = {
    productionBatchNumber: productionBatchNumber.value,
    inspections: inspections.value,
  };

  console.log("Update Post Production Verification", payload);
