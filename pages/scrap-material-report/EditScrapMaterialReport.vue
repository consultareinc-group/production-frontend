  ...
  <MainContentWrapper>
    <PageBreadcrumbs
      ...
      :items="[
        ...
        {
          label: 'Edit Scrap Material Report',
          to: { name: 'edit-scrap-material-report' },
        },
      ]"
    />
    ...
    <div>
      <q-btn
        :disable="updateScrapMaterialReportLoading"
        @click="updateScrapMaterialReport"
        no-caps
        flat
      ...
      >
        <q-spinner
          v-if="updateScrapMaterialReportLoading"
          size="24px"
          color="positive"
          class="q-mr-md"
        />
...
const updateScrapMaterialReportLoading = ref(false);
...
onMounted(() => {
  ...
  setTimeout(() => {
    scrapMaterialReportDetails.value.productionBatchNumber = +route.params.id;
    loading.value = false;
  }, 1000);
...
const updateScrapMaterialReport = () => {
  updateScrapMaterialReportLoading.value = true;
  ...
  setTimeout(() => {
    ...
    updateScrapMaterialReportLoading.value = false;
  }, 1000);
};
</script>
